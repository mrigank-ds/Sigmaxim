...
class ConditionalFieldController extends ControllerBase {
  ...
  // Changes by yugasa for dependency menu with products list.
   ...
   *   Form array.
   */
  public function provideArgumentsProducts($sigmaxim_workflow_order_type) {
    return $this->formBuilder->getForm(ConditionalFieldFormTab::class, 'sigmaxim_workflow_order', $sigmaxim_workflow_order_type);
  }
