...
class ProductsPermissions{
   ...
   *
   * @return array
   *   The Products by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (Products::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\sigmaxim_workflow\Entity\Products $type
   *   The Products type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(Products $type) {
    $type_id = $type->id();
